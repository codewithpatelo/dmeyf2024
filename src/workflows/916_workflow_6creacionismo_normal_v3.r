...
wf_junio_variables_evolutivas_prep_iter_20_parte2 <- function( pnombrewf )
{
  param_local <- exp_wf_init( pnombrewf ) # linea workflow inicial fija

  # Etapa especificacion dataset de la Segunda Competencia Kaggle
  DT_incorporar_dataset( "~/buckets/b1/datasets/dataset_iter_20_deter.csv.gz")
...
wf_junio_variables_evolutivas_prep_iter_20_parte2()
