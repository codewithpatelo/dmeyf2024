#!/usr/bin/env Rscript
cat( "ETAPA  z2402_SC_scoring_xgboost_semillerio.r  INIT\n")
...
cat( "ETAPA  z2402_SC_scoring_xgboost_semillerio.r  START\n")
action_inicializar() 
...
dfuture_matriz <- xgb.DMatrix(data.matrix(dfuture[, campos_buenos, with = FALSE]))
