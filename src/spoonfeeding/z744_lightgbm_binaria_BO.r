...
PARAM$semilla_azar <- 945799 # Aqui poner su  primer  semilla
...
PARAM$bo_iteraciones <- 221 # iteraciones de la Optimizacion Bayesiana
...
dataset <- fread("/home/pensemos_consultorias_idi/buckets/b1/exp/PP7230/dataset.csv.gz")
